...
/**
 * ForgeCode platform command renderer.
 * Renders commands as markdown with YAML frontmatter (name, description).
 * Format is identical to OpenCode - commands are .md files with frontmatter.
 */
export class ForgeCodeCommandRenderer extends BaseCommandRenderer {
  ...
  /**
   * Update or add name property in frontmatter.
   */
