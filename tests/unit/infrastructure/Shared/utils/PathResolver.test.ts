...
import { PathResolver } from '../../../../../src/infrastructure/shared/utils/PathResolver';
...
describe('PathResolver', () => {
  ...
  describe('constructor', () => {
    it('should initialize with project root', () => {
      expect(resolver.getProjectRoot()).toBe(resolve(projectRoot));
    });
  ...
  describe('resolve', () => {
    it('should resolve relative paths to absolute', () => {
      ...
      expect(result).toBe(resolve(projectRoot, 'rules/my-rule.md'));
    });

    it('should resolve absolute paths', () => {
      const absolutePath = resolve(projectRoot, 'rules/my-rule.md');
    ...
    it('should resolve parent directory segments', () => {
      ...
      expect(result).toBe(resolve(projectRoot, 'agents/my-agent.md'));
    });
  ...
  describe('isWithinProject', () => {
    it('should return true for paths within project', () => {
      expect(resolver.isWithinProject(resolve(projectRoot, 'rules'))).toBe(true);
      expect(resolver.isWithinProject(resolve(projectRoot, 'skills/my-skill'))).toBe(true);
      expect(resolver.isWithinProject(resolve(projectRoot, 'agents/my-agent.md'))).toBe(true);
    });
  ...
  describe('getRulesPath', () => {
    it('should return correct rules directory path', () => {
      ...
      expect(result).toBe(resolve(projectRoot, 'rules'));
    });
  });
  ...
  describe('getSkillsPath', () => {
    it('should return correct skills directory path', () => {
      ...
      expect(result).toBe(resolve(projectRoot, 'skills'));
    });
  });
  ...
  describe('getAgentsPath', () => {
    it('should return correct agents directory path', () => {
      ...
      expect(result).toBe(resolve(projectRoot, 'agents'));
    });
  });
  ...
  describe('getCommandsPath', () => {
    it('should return correct commands directory path', () => {
      ...
      expect(result).toBe(resolve(projectRoot, 'commands'));
    });
  });
